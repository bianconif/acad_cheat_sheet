...
\midrule
Diametro & \o & \%\%c & \textbackslash U+2205 \\
\midrule
Esigenza d'inviluppo & \circled{E} & -- & \textbackslash U+24BA \\
\midrule
Gradi & $^{\circ}$ & \%\%d & \textbackslash U+00B0 \\
\midrule
...
\\
\midrule
\texttt{\_savetime} & Modifica l'intervallo temporale (min) per il salvataggio automatico. & 
\\
\midrule
...
\midrule
\keystroke{Ctrl}+\keystroke{F4} & Chiude il documento corrente. \\
\midrule
\keystroke{Ctrl}+\keystroke{O} & Apre un documento esistente. \\
\midrule
